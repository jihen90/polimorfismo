...
ActiveRecord::Schema.define(version: 2021_10_18_153854) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.index ["platform_type", "platform_id"], name: "index_payments_on_platform_type_and_platform_id"
  end
  ...
  create_table "transbanks", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "subpay_type"
    t.integer "subpay_id"
    t.index ["subpay_type", "subpay_id"], name: "index_transbanks_on_subpay_type_and_subpay_id"
  end
